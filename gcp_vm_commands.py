...
def ssh_login_and_run_commands_script(instance_name_str,zone_str ,project_name_str,script_name):
...
def run_one_vm_cycle(instance_name_str,zone_str ,script_name ,project_name_str='shelfauditdec19'):
